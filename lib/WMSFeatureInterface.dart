...
// parse the result from GeoJson to dynamic Map.
    ...
    // testing api and dB readings below.
    //----------


    print ("result printed from interface: $result)");

      var features = result['features'];
      Map <String, dynamic> featuresMap = new Map <String, dynamic>.from(features[0]);
      var properties = featuresMap['properties'];
    Map <String, dynamic> propertiesMap =new Map <String, dynamic>.from(properties);
